...
const XP_PER_TOOL_CALL = 50;
const XP_PER_FILE_EDIT = 100;
const XP_PER_TEST_RUN = 200;
const XP_PER_10_MINUTES = 100;
const XP_DURATION_CAP = 3000;
const XP_SESSION_FLAT = 500;
